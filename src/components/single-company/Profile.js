  ...
  return (
    <>
      <section className="pt-16 bg-blueGray-50">
        <div className="w-full lg:w-7/14 px-4 mx-auto">
              ...
              <div className="flex flex-wrap justify-center">
                <div className="w-full px-4 flex justify-center">
                  <div className="relative w-40 h-40 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                    <svg
                      className="absolute w-42 h-42 text-gray-400 -left-1"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">
                    <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                      ...
                      individuals to engage in and operate a business—commercial
                      or industrial—enterprise. A company may be organized in
                      various ways for tax and financial liability purposes
            ...
            >
              <div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="flex flex-col space-y-4">
                  <div>
                    <h2 className="text-2xl font-semibold">Moahamed Asjedh</h2>
                    <span className="text-sm dark:text-gray-400">Founder</span>
                  </div>
