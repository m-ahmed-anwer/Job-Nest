  ...
  if (auth.currentUser) {
    return (
      <div>
          ...
          <div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
            ...
            <div className="flex flex-wrap justify-center lg:justify-between">
              ...
              <svg
                ...
                viewBox="0 0 32 32"
                aria-label="Next.js"
                className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 dark:text-blue-500"
              >
                <title>Next.js</title>
        ...
        <section class="flex items-center justify-center  dark:bg-gray-800 lg:h-screen">
          <div class="px-4 py-20 mx-auto max-w-7xl">
              ...
              <div class="text-center ">
                <div class="relative flex flex-col items-center">
                  ...
                  <h1 class="text-5xl font-bold dark:text-white">
                    {" "}
                    Our <span class="text-blue-500"> Features</span>{" "}
                  </h1>
            ...
            <div class="grid grid-cols-1 gap-x-4 gap-y-6 lg:gap-x-8 lg:gap-y-8 md:grid-cols-2 lg:grid-cols-3">
              <div class="w-full p-8 mb-5 text-center transition-all bg-white rounded shadow dark:bg-gray-700 hover:shadow-lg">
                ...
                <h3 class="mb-4 text-2xl font-semibold dark:text-white">
                  {" "}
                  Self Fixing Cogs{" "}
                </h3>
                <p class="text-base text-gray-500 dark:text-gray-400">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem
                  cupiditate similique, iure minus sed fugit obcaecati minima
                  quam reiciendis dicta!
                </p>
              </div>
